...
`.github/workflows/ci.yml` defines **102** jobs, `codeql.yml` one more and `ruleset-audit.yml`
one more: **104** across the three, producing **107** status-check contexts. Ruleset `21815299`
requires all **104** today. Its predecessor `19007209` required **22** of them before
...
That intended set is **104 required contexts and 3 reasoned exemptions**: `fuzz` (a 30-second
