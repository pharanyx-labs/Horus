...
The intended set is **117 required, 3 exempted** (117 jobs, 120 contexts (re-derive it with
...
**empty**, all 94 properties name a witness that resolves.
...
| ✅ | 331 `smoke-*` targets (`grep -c '^smoke-[a-z0-9-]*:' Makefile`), nearly all QEMU integration self-tests, several adversarial, and 171 of them control arms that must reproduce a defect |
