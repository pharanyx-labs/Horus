...
`.github/workflows/ci.yml` defines **81** jobs, `codeql.yml` one more and `ruleset-audit.yml`
one more — **83** across the three, producing **86** status-check contexts. Ruleset `19007209`
...
That intended set is **82 required contexts and 4 reasoned exemptions** — `fuzz` (a 30-second
