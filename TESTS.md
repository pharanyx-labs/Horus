...
`.github/workflows/ci.yml` defines **74** jobs, run on every push and pull request;
...
below — **76** jobs, **79** contexts. Counts from `tools/check_ci_gating.py`, which prints them;
...
The intended set is **75 required contexts and 4 reasoned exemptions** — read off
