...
`.github/workflows/ci.yml` defines **75** jobs, run on every push and pull request;
...
below — **77** jobs, **80** contexts. Counts from `tools/check_ci_gating.py`, which prints them;
...
The intended set is **76 required contexts and 4 reasoned exemptions** — read off
