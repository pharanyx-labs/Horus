...
`.github/workflows/ci.yml` defines **78** jobs, run on every push and pull request;
...
below — **80** jobs, **83** contexts. Counts from `tools/check_ci_gating.py`, which prints them;
...
The intended set is **79 required contexts and 4 reasoned exemptions** — read off
