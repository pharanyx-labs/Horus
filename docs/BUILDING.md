...
| Target | Asserts |
|---|---|
| `smoke-captest` | Unheld capabilities, post-revoke use, and bad input are all refused (104 checks — read the count off `CAPTEST: PASS <n> checks` on the wire, not from here) |
