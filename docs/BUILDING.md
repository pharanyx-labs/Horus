...
defaults of a machine with no volume. **An installed disk does not have them** -- its account
table lives on the volume, and the password is the one chosen during the install.
