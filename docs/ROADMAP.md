...
The intended set is **110 required, 3 exempted** (110 jobs, 113 contexts (re-derive it with
...
**empty**, all 87 properties name a witness that resolves.
...
| ✅ | 311 `smoke-*` targets (`grep -c '^smoke-[a-z0-9-]*:' Makefile`), nearly all QEMU integration self-tests, several adversarial, and 162 of them control arms that must reproduce a defect |
