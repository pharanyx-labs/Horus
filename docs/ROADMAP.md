...
**empty**, all 67 properties name a witness that resolves.
...
| ✅ | 196 `smoke-*` targets (`grep -c '^smoke-[a-z0-9-]*:' Makefile`), nearly all QEMU integration self-tests, several adversarial, and 92 of them control arms that must reproduce a defect |
