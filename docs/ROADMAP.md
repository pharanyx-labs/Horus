...
The intended set is **106 required, 3 exempted** (106 jobs, 109 contexts (re-derive it with
...
**empty**, all 77 properties name a witness that resolves.
...
| ✅ | 226 `smoke-*` targets (`grep -c '^smoke-[a-z0-9-]*:' Makefile`), nearly all QEMU integration self-tests, several adversarial, and 108 of them control arms that must reproduce a defect |
