...
proofs. `.github/workflows/ci.yml` runs 129 jobs, most of them QEMU integration self-tests.
...
(**[C-6]**). The gating set is 131 of its 134 contexts, including every security test. The
...
2. **QEMU integration self-tests**, the bulk of CI's 129 jobs; each boots a purpose-built
