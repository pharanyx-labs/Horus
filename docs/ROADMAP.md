...
The intended set is **105 required, 3 exempted** (105 jobs, 108 contexts (re-derive it with
...
**empty**, all 76 properties name a witness that resolves.
...
| ✅ | 224 `smoke-*` targets (`grep -c '^smoke-[a-z0-9-]*:' Makefile`), nearly all QEMU integration self-tests, several adversarial, and 107 of them control arms that must reproduce a defect |
