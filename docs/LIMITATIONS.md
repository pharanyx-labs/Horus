...
`.github/workflows/ci.yml` defines **82** jobs, `codeql.yml` one more and `ruleset-audit.yml`
one more — **84** across the three, producing **87** status-check contexts. Ruleset `19007209`
...
That intended set is **83 required contexts and 4 reasoned exemptions** — `fuzz` (a 30-second
