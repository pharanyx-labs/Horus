...
proofs. `.github/workflows/ci.yml` runs 130 jobs, most of them QEMU integration self-tests.
...
(**[C-6]**). The gating set is 131 of its 135 contexts, including every security test. The
...
2. **QEMU integration self-tests**, the bulk of CI's 130 jobs; each boots a purpose-built
