...
The gating set is **133 required, 4 exempted** (134 jobs, 137 contexts (re-derive it with
...
**empty**, all 106 properties name a witness that resolves.
...
| ✅ | 394 `smoke-*` targets (`grep -c '^smoke-[a-z0-9-]*:' Makefile`), nearly all QEMU integration self-tests, several adversarial, and 205 of them control arms that must reproduce a defect |
