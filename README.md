...
proofs. `.github/workflows/ci.yml` runs 117 jobs, most of them QEMU integration self-tests.
...
(**[C-6]**). The intended set is 119 of its 122 contexts, including every security test; the
...
2. **QEMU integration self-tests**, the bulk of CI's 117 jobs; each boots a purpose-built
