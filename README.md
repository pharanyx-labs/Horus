...
proofs. `.github/workflows/ci.yml` runs 107 jobs, most of them QEMU integration self-tests.
...
(**[C-6]**). The intended set is 109 of its 112 contexts, including every security test; the
...
2. **QEMU integration self-tests**, the bulk of CI's 107 jobs; each boots a purpose-built
