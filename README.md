...
Capability revocation carries Kani proofs. `.github/workflows/ci.yml` runs 88 jobs, most of
...
gating, or exempted with a written reason (**[C-6]**). The intended set is 90 of its 93 contexts,
...
2. **QEMU integration self-tests** — the bulk of CI's 88 jobs; each boots a purpose-built
