...
| ✅ | 190 `smoke-*` targets (`grep -c '^smoke-[a-z0-9-]*:' Makefile`), nearly all QEMU integration self-tests, several adversarial, and 88 of them control arms that must reproduce a defect |
