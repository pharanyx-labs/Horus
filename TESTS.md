...
`.github/workflows/ci.yml` defines **132** jobs, run on every push and pull request;
...
below: **134** jobs, **137** contexts. Counts from `tools/check_ci_gating.py`, which prints
...
The set is **133 gating contexts and 4 reasoned exemptions** (read off
...
`.github/invariants.yml` holds exemptions only, and is currently **empty**: all 106 properties
