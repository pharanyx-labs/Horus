...
proofs. `.github/workflows/ci.yml` runs 109 jobs, most of them QEMU integration self-tests.
...
(**[C-6]**). The intended set is 111 of its 114 contexts, including every security test; the
...
2. **QEMU integration self-tests**, the bulk of CI's 109 jobs; each boots a purpose-built
