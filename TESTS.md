...
`.github/workflows/ci.yml` defines **110** jobs, run on every push and pull request;
...
below: **112** jobs, **115** contexts. Counts from `tools/check_ci_gating.py`, which prints
...
The intended set is **112 required contexts and 3 reasoned exemptions** (read off
...
`.github/invariants.yml` holds exemptions only, and is currently **empty**: all 89 properties
