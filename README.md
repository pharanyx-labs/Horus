...
proofs. `.github/workflows/ci.yml` runs 132 jobs, most of them QEMU integration self-tests.
...
(**[C-6]**). The gating set is 133 of its 137 contexts, including every security test. The
...
2. **QEMU integration self-tests**, the bulk of CI's 132 jobs; each boots a purpose-built
