...
The gating set is **134 required, 4 exempted** (135 jobs, 138 contexts (re-derive it with
...
| ✅ | 410 `smoke-*` targets (`grep -c '^smoke-[a-z0-9-]*:' Makefile`), nearly all QEMU integration self-tests, several adversarial, and 213 of them control arms that must reproduce a defect |
