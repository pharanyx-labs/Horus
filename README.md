...
proofs. `.github/workflows/ci.yml` runs 110 jobs, most of them QEMU integration self-tests.
...
(**[C-6]**). The intended set is 112 of its 115 contexts, including every security test; the
...
2. **QEMU integration self-tests**, the bulk of CI's 110 jobs; each boots a purpose-built
