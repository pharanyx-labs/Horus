...
proofs. `.github/workflows/ci.yml` runs 108 jobs, most of them QEMU integration self-tests.
...
(**[C-6]**). The intended set is 110 of its 113 contexts, including every security test; the
...
2. **QEMU integration self-tests**, the bulk of CI's 108 jobs; each boots a purpose-built
