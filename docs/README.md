...
| [`design/shared-libc.md`](design/shared-libc.md) | Roadmap 2.5 in the shipped system: who holds the shared libc, how a program links it by name in a ring-3 linker, the private data, and the seal that makes the resolved table read-only: **step 1 built** (S106); its decisions are taken |
