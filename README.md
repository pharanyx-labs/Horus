...
Capability revocation carries Kani proofs. `.github/workflows/ci.yml` runs 75 jobs, most of
...
gating, or exempted with a written reason (**[C-6]**). The intended set is 76 of its 80 contexts,
...
2. **QEMU integration self-tests** — the bulk of CI's 75 jobs; each boots a purpose-built
