...
proofs. `.github/workflows/ci.yml` runs 133 jobs, most of them QEMU integration self-tests.
...
(**[C-6]**). The gating set is 134 of its 138 contexts, including every security test. The
...
2. **QEMU integration self-tests**, the bulk of CI's 133 jobs; each boots a purpose-built
