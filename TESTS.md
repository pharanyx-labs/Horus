...
`.github/workflows/ci.yml` defines **118** jobs, run on every push and pull request;
...
below: **120** jobs, **123** contexts. Counts from `tools/check_ci_gating.py`, which prints
...
The intended set is **120 required contexts and 3 reasoned exemptions** (read off
