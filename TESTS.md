...
`.github/workflows/ci.yml` defines **79** jobs, run on every push and pull request;
...
below — **81** jobs, **84** contexts. Counts from `tools/check_ci_gating.py`, which prints them;
...
The intended set is **80 required contexts and 4 reasoned exemptions** — read off
