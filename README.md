...
proofs. `.github/workflows/ci.yml` runs 104 jobs, most of them QEMU integration self-tests.
...
(**[C-6]**). The intended set is 106 of its 109 contexts, including every security test; the
...
2. **QEMU integration self-tests**, the bulk of CI's 104 jobs; each boots a purpose-built
