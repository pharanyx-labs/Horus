...
The intended set is **119 required, 3 exempted** (119 jobs, 122 contexts (re-derive it with
...
**empty**, all 95 properties name a witness that resolves.
...
| ✅ | 333 `smoke-*` targets (`grep -c '^smoke-[a-z0-9-]*:' Makefile`), nearly all QEMU integration self-tests, several adversarial, and 172 of them control arms that must reproduce a defect |
