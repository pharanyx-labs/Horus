...
- **4.12 ✅ A security-invariant registry — [F-4.1]** — *landed 2026-08-28*.
  ...
  **empty** — all 54 properties name a witness that resolves.
...
| ✅ | 164 `smoke-*` targets (`grep -c '^smoke-[a-z0-9-]*:' Makefile`), nearly all QEMU integration self-tests, several adversarial, and 68 of them control arms that must reproduce a defect |
