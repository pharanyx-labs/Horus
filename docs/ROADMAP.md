...
**empty**, all 102 properties name a witness that resolves.
...
| ✅ | 368 `smoke-*` targets (`grep -c '^smoke-[a-z0-9-]*:' Makefile`), nearly all QEMU integration self-tests, several adversarial, and 192 of them control arms that must reproduce a defect |
