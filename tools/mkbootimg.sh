...
#
# Usage: mkbootimg.sh <kernel.elf> <assembled-grub.cfg> <out-eltorito.img>
#
# ---------------------------------------------------------------------------
...
#     EXIST for i386-pc in Debian's grub-pc-bin -- only for x86_64-efi. Horus is
#     BIOS/Multiboot2, so that door is shut.
