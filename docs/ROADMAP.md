...
The intended set is **113 required, 3 exempted** (113 jobs, 116 contexts (re-derive it with
...
**empty**, all 93 properties name a witness that resolves.
...
| ✅ | 327 `smoke-*` targets (`grep -c '^smoke-[a-z0-9-]*:' Makefile`), nearly all QEMU integration self-tests, several adversarial, and 169 of them control arms that must reproduce a defect |
