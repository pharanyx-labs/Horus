...
`.github/workflows/ci.yml` defines **90** jobs, `codeql.yml` one more and `ruleset-audit.yml`
one more — **92** across the three, producing **95** status-check contexts. Ruleset `19007209`
...
That intended set is **92 required contexts and 3 reasoned exemptions** — `fuzz` (a 30-second
