...
**Which invariant does this change preserve?** <!-- Name it, ideally by its ID from the table in
SECURITY.md, e.g. "S3: revoking a capability revokes its entire derivation subtree,
system-wide". -->

**What is the witness?** <!-- The test or proof that would fail if the invariant broke. If none
exists, adding it is part of this PR, see CONTRIBUTING.md. "No test exists" is not an exemption.
-->
