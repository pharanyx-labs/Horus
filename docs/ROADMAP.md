...
The intended set is **109 required, 3 exempted** (109 jobs, 112 contexts (re-derive it with
...
| ✅ | 260 `smoke-*` targets (`grep -c '^smoke-[a-z0-9-]*:' Makefile`), nearly all QEMU integration self-tests, several adversarial, and 132 of them control arms that must reproduce a defect |
