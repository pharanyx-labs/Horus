...
Capability revocation carries Kani proofs. `.github/workflows/ci.yml` runs 83 jobs, most of
...
gating, or exempted with a written reason (**[C-6]**). The intended set is 84 of its 88 contexts,
...
2. **QEMU integration self-tests** — the bulk of CI's 83 jobs; each boots a purpose-built
