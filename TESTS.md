...
`.github/workflows/ci.yml` defines **109** jobs, run on every push and pull request;
...
below: **111** jobs, **114** contexts. Counts from `tools/check_ci_gating.py`, which prints
...
The intended set is **111 required contexts and 3 reasoned exemptions** (read off
...
`.github/invariants.yml` holds exemptions only, and is currently **empty**: all 88 properties
