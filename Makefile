...
DEFECT_FLAGS = \
	...
	TASKINFO_WIDE_AUTHORITY WAIT_TCB_UNCHECKED TCB_GENERATION_UNCHECKED APIC_ID_IS_CPU_INDEX SMT_SIBLING_BY_INDEX SLOT_REUSE_UNCHECKED KSTACK_REUSE_WIDEN GETLINE_SLOT3_FALLBACK CAP_LOOKUP_ASSERT_HANG \
